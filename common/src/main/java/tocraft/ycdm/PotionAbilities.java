...
public class PotionAbilities {
	...
	public static final Logger LOGGER = LogManager.getLogger(PotionAbilities.class);
	public static final String MODID = "ycdm";
	public static String versionURL = "https://raw.githubusercontent.com/ToCraft/potionabilities/1.16.5/gradle.properties";
